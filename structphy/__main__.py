...
@click.option('-n', '--n_bootstraps', type=int, default=10000)
def main(structdir: Path, fasta: io.TextIOWrapper, threads: int, n_bootstraps: int):
    ...
    if structdir:
        ...
        generate_bootstrap_matrices_from_structures(structure_files, n_threads=threads, n_bootstraps=n_bootstraps)
